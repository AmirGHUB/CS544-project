...
//    private DataSource dataSource;
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth
                ...
                .and()
                .withUser("checker").password(passwordEncoder().encode("checker")).roles("CHECKER")
                .and()
...
//          .authoritiesByUsernameQuery( "select u1.username, u2.authority from credentials u1, authorities u2 where u1.username = u2.username and u1.username =?" );
//    }
//FOR IN MEMORY AUTH
	    @Override
    protected void configure(HttpSecurity http) throws Exception {
			http
					...
					.authorizeRequests()
//					.antMatchers("*/appointment/new").hasAnyRole("ADMIN", "CHECKER")
//					.antMatchers("*/reservation/new").hasAnyRole("ADMIN", "CHECKER", "STUDENT")
...
////				.antMatchers("/editbyid/**").hasRole("ADMIN")
////				.antMatchers( "/editcustomer" ).hasAnyRole( "ADMIN","USER" )
